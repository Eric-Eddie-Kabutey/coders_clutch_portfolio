...
function DigitalBrands() {
  const brandBank = [
    ...
    const impactStats = [
      { id: 1, value: "15+", label: "Countries we served", percentage: 100, color: "#00312F" },
      { id: 2, value: "150+", label: "Clients like family", percentage: 70, color: "#FF6900" },
      { id: 3, value: "200+", label: "Solutions for seekers", percentage: 77, color: "#FFCB40" },
      { id: 4, value: "500+", label: "Senior tech experts", percentage: 40, color: "#2E76F6" },
    ];
    ...
    <div className='w-full pb-24'>
      <section className='max-container 2xl:w-[85%] md:w-[95%] w-[90%] mx-auto flex lg:flex-row flex-col items-stretch justify-between'>
        <div className='flex-1 pt-20 flex flex-col gap-4'>
            ...
            <div className='grid sm:grid-cols-2 grid-cols-1 gap-8 sm:justify-items-start'>
                {impactStats.map(({ id, value, label, percentage, color }) => {
