...
import outsourcingImg from "@/public/assets/images/solutions/codersclutch_company.png"
import Image from 'next/image';

    function OutsourceMainHero() {
    return (
                ...
                <section className='2xl:w-[80%] xl:w-[90%] h-full mx-auto flex flex-col justify-end gap-12'>
                    <div className='flex flex-col gap-3'>
                        <Typography
                            ...
                            className="text-app-primary-medium font-semibold uppercase text-center">From Concept To Product Launch</Typography>
                        <Typography
                            className='text-center '
                            typo="header-4-semibold"
                        >
                            A Next-Gen Software Outsourcing Company
                        </Typography>
                        <Typography
                            className='xl:w-[50%] lg:w-[60%] mx-auto text-center '
                            typo="body-medium-regular"
                        >
                            We help businesses transform ideas into successful, future-ready products through innovative 
    ...
    export default OutsourceMainHero