...
import publicSafetyImg from "@/public/assets/images/solutions/data_ai_dashboardImg.svg"
// import publicSafetyImg2 from "@/public/assets/images/solutions/safety2.png"
...
export default function DataManagementMainHero() {
              ...
              <section className='2xl:w-[80%] xl:w-[90%] w-full h-full mx-auto flex flex-col justify-end gap-12'>
                  <div className='flex flex-col gap-4'>
                      <Typography
                          ...
                          className="text-app-primary-medium font-semibold uppercase text-center">Data & AI Management Solutions</Typography>
                      <Typography
                          className='text-center '
                          typo="header-4-semibold"
                      >
                        Turning Urban Data into Actionable Intelligence
                      </Typography>
                      <Typography
