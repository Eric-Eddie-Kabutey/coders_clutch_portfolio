...
function SmartEducationApproach() {
    const [hoveredId, setHoveredId] = useState<string | null>("0]1");
                ...
                <div className='flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6'>
                    <div className='flex flex-col gap-2'>
                        ...
                        <Typography typo="header-3-semibold" className='!text-app-primary-deep !font-bold capitalize'>
                            Smart Education Transformation
                        </Typography>
                    </div>
                    <Typography typo="body-medium-regular" className="text-gray-500 max-w-md hidden md:block">
                        A holistic, tech-driven methodology to modernize learning environments and empower the next generation of digital citizens.
                    </Typography>
                </div>
