...
import { Binoculars, ChartLineUp, FirstAidKit, Lightning, ShieldCheck, UsersThree } from '@phosphor-icons/react';
...
const product_services = [
    ...
    },
    {
        ...
        icon: ChartLineUp,
        description: `Response time benchmarks, hotspot mapping, and resource allocation insights.`,
    },
    {
        id: "6",
        title: "Medical Emergency Coordination",
        icon: FirstAidKit,
        description: `Hospital bed tracking, paramedic guidance, and patient handoff automation.`,
    }
]
