...
const mvp_workflows = [
    {
        ...
        sub_title: "& Risk Profiling",
        description: "Mapping emergency trends, incident response gaps, and tech needs.",
    ...
    },
    {
        ...
        description: "Interoperable framework to connect 911 systems, CCTV, mobile responders, and sensors.",
    ...
    },
    {
        ...
        description: "Syncing field units with real-time command centers.",
        accent: "from-yellow-500/10 to-app-secondary/10"
    },
    {
        id: "4",
        icon: agileIcon,
        title: "Training",
        sub_title: "& Simulation",
        description: "End-user training for responders and emergency control personnel.",
        accent: "from-app-secondary/10 to-blue-500/10"
    },
    {
        id: "5",
        icon: deploymentIcon,
        title: "Live Testing",
        sub_title: " & Scaling",
        description: "City-wide pilot launches and system scalability checks.",
        accent: "from-blue-500/10 to-indigo-500/10"
    },
]

function PublicSafetyApproach() {
    ...
    return (
        <div className='w-full md:py-32 py-20 bg-white overflow-hidden relative'>
            ...
            <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-app-secondary/5 rounded-full blur-[100px] -ml-48 -mb-48" />
            ...
            <section className='max-container 2xl:w-[85%] md:w-[95%] w-[90%] relative z-10'>
                <div className='flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6'>
                    ...
                    <Typography typo="body-medium-regular" className="text-gray-500 max-w-md hidden md:block">
                        A comprehensive, tech-enabled strategy to enhance urban security, streamline emergency response, and foster safer communities.
                    </Typography>
                </div>
...
export default PublicSafetyApproach