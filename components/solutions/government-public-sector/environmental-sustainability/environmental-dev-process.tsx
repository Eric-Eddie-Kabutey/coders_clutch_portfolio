...
const mvp_workflows = [
    {
        ...
        accent: "from-green-500/10 to-teal-500/10"
    },
    {
        id: "2",
        ...
        accent: "from-teal-500/10 to-blue-500/10"
    },
    {
        id: "3",
        icon: testingIcon,
    ...
    },
    {
        ...
        accent: "from-purple-500/10 to-gray-500/10"
    },
]
            ...
            <section className='max-container 2xl:w-[85%] md:w-[95%] w-[90%] relative z-10'>
                <div className='flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6'>
                    ...
                    <Typography typo="body-medium-regular" className="text-gray-500 max-w-md hidden md:block">
                        A data-driven workflow designed to minimize ecological footprints while maximizing urban efficiency and resilience.
                    </Typography>
                </div>
