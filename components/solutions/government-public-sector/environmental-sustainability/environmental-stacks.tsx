...
import { environmental_stacks } from "@/constant";
import { ArrowRight, CheckCircle } from "lucide-react";
import React, { useState } from "react";

function EnvironmentalStacks() {
  const [showAll, setShowAll] = useState(false);
  const displayedChoices = showAll
    ? environmental_stacks
    : environmental_stacks.slice(0, 3);
  const hasMoreChoices = environmental_stacks.length > 3;
  return (
...
export default EnvironmentalStacks;
