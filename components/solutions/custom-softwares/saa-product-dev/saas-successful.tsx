...
function SaasSuccessful() {
  return (
    <div className='w-full md:py-32 py-20'>
        <section className='max-container 2xl:w-[85%] md:w-[95%] w-[90%] mx-auto'>
            <div className='inter xl:pb-12 pb-10 flex flex-col gap-1'>
                <Typography
                    typo="header-3-light"
                >
                    What Successful SaaS Businesses
                </Typography>
                <Typography
                    typo="header-3-semibold"
                    className='!font-bold capitalize'
                >
                    Say About CONTUS Tech
                </Typography>
            </div>
            <Carousel
                className="w-full" 
