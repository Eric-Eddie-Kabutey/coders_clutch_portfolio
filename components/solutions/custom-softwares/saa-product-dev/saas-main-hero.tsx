...
import publicSafetyImg from "@/public/assets/images/solutions/saas_heroImg.svg"
...
export default function SaasMainHero() {
              ...
              <section className='2xl:w-[80%] xl:w-[90%] w-full h-full mx-auto flex flex-col justify-end gap-12'>
                  <div className='flex flex-col gap-4'>
                      <Typography
                          ...
                          className="text-app-primary-medium font-semibold uppercase text-center">#1 SaaS Product</Typography>
                      <Typography
                          className='text-center '
                          typo="header-4-semibold"
                      >
                        Development Company To Build Digital Products
                      </Typography>
                      <Typography
                  ...
                  <div className="w-full lg:py-6 py-3 flex justify-between items-center lg:gap-8 gap-8">
                    <div className="bg-[#f4f2ec] w-full xl:h-fit lg:h-[550px] md:h-[500px] sm:h-[400px] xs:h-[300px] h-[250px] p-3 border-2 border-dashed rounded-[2rem] overflow-hidden ">
                      <Image 
                        src={publicSafetyImg}
                        alt="outsourcing image"
                        className="w-full h-full pt-32 rounded-[2rem] object-cover bg-white"
                      />  
                    </div>
                  </div>
              </section>
