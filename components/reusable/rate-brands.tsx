...
const RateBrands = () => {
  ...
  const impactStats = [
    { id: 1, value: "100+", label: "Dedicated MVP Engineers", percentage: 100, color: "#00312F" },
    { id: 2, value: "500+", label: "MVP Projects Delivered", percentage: 70, color: "#FF6900" },
    { id: 3, value: "70+", label: "Countries We Served", percentage: 77, color: "#FFCB40" },
    { id: 4, value: "17+", label: "Total Years of Experience", percentage: 40, color: "#2E76F6" },
  ];
  ...
  return (
    <div className='w-full pb-32 bg-gradient-to-b from-white to-[#d7f7f4]'>
