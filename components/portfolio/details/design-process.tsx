...
const Icons = {
  ...
  strategy: (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 15 15" fill="none">
        ...
        <path fillRule="evenodd" clipRule="evenodd" d="M10.3951 0.0584124C11.1666 0.117329 11.8112 0.238413 12.3664 0.510473C13.0142 0.73891 13.4849 1.1474 13.9634 1.66567L15 2.5L14.5 3L13.5 2.5C13 2.1474 12.5 1.89021 12 1.73891C11.5 1.58413 11 1.5 10.5 1.45841L10.3951 0.0584124Z" fill="#101820"/>
    </svg>
  ),
  solution: (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 17 15" fill="none">
        <path fillRule="evenodd" clipRule="evenodd" d="M8.59218 0C5.38961 0 2.79341 2.5962 2.79341 5.79877C2.79341 8.20478 3.98593 10.2907 5.72728 11.4798L6.5 12.5L7.5 12L7 11.5C6 10.5 5 9 4.5 7.5C4 6 3.98593 4.5 4.33287 3.5C4.67981 2.5 5.59218 1.5 8.59218 1C11.5922 0.5 12.5 0.5 14 1C15.5 1.5 16.5 3 16.5 5.5C16.5 8 15 10 13.5 11.5L13 12.5L14 13L15 12.5C16 11.5 17 9 17 5.79877C17 2.5962 14.4038 0 11.2012 0C10.5 0 9.5 0 8.59218 0Z" fill="#2D264B"/>
    </svg>
  )
};
